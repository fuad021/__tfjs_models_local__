...
},{"base64-js":"FRly","ieee754":"Quj6","isarray":"aq/z","buffer":"aMB2"}],"PqBP":[function(require,module,exports) {
var global = arguments[3];
...
gt = Uh;
},{"crypto":"sC8V","node-fetch":"sC8V","util":"sC8V","process":"g5I+","buffer":"aMB2"}],"1rGP":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
"use strict";
...
},{"@tensorflow/tfjs-core":"PqBP","buffer":"aMB2"}],"XIac":[function(require,module,exports) {
"use strict";
...
const disposeBox = t => {
  t.startEndTensor.dispose(), t.startPoint.dispose(), t.endPoint.dispose();
      ...
      createBox = t => ({
  startEndTensor: t,
  startPoint: (0, _tfjsCore.slice)(t, [0, 0], [-1, 2]),
  endPoint: (0, _tfjsCore.slice)(t, [0, 2], [-1, 2])
}),
      scaleBox = (t, o) => {
  const s = (0, _tfjsCore.mul)(t.startPoint, o),
        e = (0, _tfjsCore.mul)(t.endPoint, o),
        i = (0, _tfjsCore.concat2d)([s, e], 1);
  return createBox(i);
},
      ANCHORS_CONFIG = {
  strides: [8, 16],
...
function decodeBounds(t, o, s) {
  const e = (0, _tfjsCore.slice)(t, [0, 1], [-1, 2]),
        i = (0, _tfjsCore.add)(e, o),
        n = (0, _tfjsCore.slice)(t, [0, 3], [-1, 2]),
        a = (0, _tfjsCore.div)(n, s),
        r = (0, _tfjsCore.div)(i, s),
        c = (0, _tfjsCore.div)(a, 2),
        l = (0, _tfjsCore.sub)(r, c),
        d = (0, _tfjsCore.add)(r, c),
        h = (0, _tfjsCore.mul)(l, s),
        p = (0, _tfjsCore.mul)(d, s);
  return (0, _tfjsCore.concat2d)([h, p], 1);
}
...
function flipFaceHorizontal(t, o) {
  ...
  if (null != t.probability && (s.probability = t.probability instanceof _tfjsCore.Tensor ? t.probability.clone() : t.probability), t.topLeft instanceof _tfjsCore.Tensor && t.bottomRight instanceof _tfjsCore.Tensor) {
    const [e, i] = (0, _tfjsCore.tidy)(() => [(0, _tfjsCore.concat)([(0, _tfjsCore.sub)(o - 1, t.topLeft.slice(0, 1)), t.topLeft.slice(1, 1)]), (0, _tfjsCore.concat)([(0, _tfjsCore.sub)(o - 1, t.bottomRight.slice(0, 1)), t.bottomRight.slice(1, 1)])]);

    if (s.topLeft = e, s.bottomRight = i, null != t.landmarks) {
      const e = (0, _tfjsCore.tidy)(() => (0, _tfjsCore.sub)((0, _tfjsCore.tensor1d)([o - 1, 0]), t.landmarks).mul((0, _tfjsCore.tensor1d)([1, -1])));
      s.landmarks = e;
    }
  } else {
    const [e, i] = t.topLeft,
          [n, a] = t.bottomRight;
    s.topLeft = [o - 1 - e, i], s.bottomRight = [o - 1 - n, a], null != t.landmarks && (s.landmarks = t.landmarks.map(t => [o - 1 - t[0], t[1]]));
  }
...
class BlazeFaceModel {
  constructor(t, o, s, e, i, n) {
    this.blazeFaceModel = t, this.width = o, this.height = s, this.maxFaces = e, this.anchorsData = generateAnchors(o, s, ANCHORS_CONFIG), this.anchors = (0, _tfjsCore.tensor2d)(this.anchorsData), this.inputSizeData = [o, s], this.inputSize = (0, _tfjsCore.tensor1d)([o, s]), this.iouThreshold = i, this.scoreThreshold = n;
  }

  async getBoundingBoxes(t, o, s = !0) {
    const [e, i, n] = (0, _tfjsCore.tidy)(() => {
      const o = t.resizeBilinear([this.width, this.height]),
            s = (0, _tfjsCore.mul)((0, _tfjsCore.sub)(o.div(255), .5), 2),
            e = this.blazeFaceModel.predict(s).squeeze(),
            i = decodeBounds(e, this.anchors, this.inputSize),
            n = (0, _tfjsCore.slice)(e, [0, 0], [-1, 1]);
      return [e, i, (0, _tfjsCore.sigmoid)(n).squeeze()];
    }),
          a = console.warn;

    console.warn = () => {};

    const r = _tfjsCore.image.nonMaxSuppression(i, n, this.maxFaces, this.iouThreshold, this.scoreThreshold);

    console.warn = a;
    const c = await r.array();
    r.dispose();
    let l = c.map(t => (0, _tfjsCore.slice)(i, [t, 0], [1, -1]));
    ...
    const d = t.shape[1],
          h = t.shape[2];
    let p;
    p = o ? (0, _tfjsCore.div)([h, d], this.inputSize) : [h / this.inputSizeData[0], d / this.inputSizeData[1]];
    const u = [];

    for (let t = 0; t < l.length; t++) {
      const i = l[t],
            a = (0, _tfjsCore.tidy)(() => {
        const a = createBox(i instanceof _tfjsCore.Tensor ? i : (0, _tfjsCore.tensor2d)(i));
        if (!s) return a;
        const r = c[t];
        let l;
        return l = o ? this.anchors.slice([r, 0], [1, 2]) : this.anchorsData[r], {
          box: a,
          landmarks: (0, _tfjsCore.slice)(e, [r, NUM_LANDMARKS - 1], [1, -1]).squeeze().reshape([NUM_LANDMARKS, -1]),
          probability: (0, _tfjsCore.slice)(n, [r], [1]),
          anchor: l
        };
      });
      u.push(a);
  ...
  async estimateFaces(t, o = !1, s = !1, e = !0) {
    const [, i] = getInputTensorDimensions(t),
          n = (0, _tfjsCore.tidy)(() => (t instanceof _tfjsCore.Tensor || (t = _tfjsCore.browser.fromPixels(t)), t.toFloat().expandDims(0))),
          {
      boxes: a,
      scaleFactor: r
...
async function load({
  ...
  const n = await (0, _tfjsConverter.loadGraphModel)(BLAZEFACE_MODEL_URL, {
    fromTFHub: !0
  });
  return new BlazeFaceModel(n, o, s, t, e, i);
}
},{"@tensorflow/tfjs-core":"PqBP","@tensorflow/tfjs-converter":"1rGP"}],"M1oU":[function(require,module,exports) {
var process = require("process");
var __dirname = "/Users/annyuan/Documents/projects/tfjs-core-wrapper/tfjs-models/blazeface/demo/node_modules/@tensorflow/tfjs-backend-wasm/dist";
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setWasmPath = te;
exports.BackendWasm = void 0;
...
function c(t) {
  var a;
  (0, _tfjsCore.registerKernel)({
    kernelName: t,
    backendName: "wasm",
    setupFunc: function (e) {
      a = e.wasm.cwrap(t, null, ["number", "number"]);
    },
    kernelFunc: function (e) {
      ...
      return 0 === _tfjsCore.util.sizeFromShape(i.shape) ? i : (a(u, o), i);
    }
  });
}
...
function b(a, r, u) {
  ...
  (0, _tfjsCore.registerKernel)({
    ...
    backendName: "wasm",
    setupFunc: function (e) {
      i = e.wasm.cwrap(a, null, ["number", "array", "number", "number", "array", "number", "number", "number"]);
    },
    kernelFunc: function (e) {
      var o = e.backend,
          s = e.inputs,
          d = s.a,
          p = s.b,
          l = o.dataIdMap.get(d.dataId).id,
          m = o.dataIdMap.get(p.dataId).id,
          c = null != u ? u : d.dtype,
          b = _tfjsCore.backend_util.assertAndGetBroadcastShape(d.shape, p.shape),
          h = o.makeOutput(b, c);

      if (0 === _tfjsCore.util.sizeFromShape(b)) return h;

      var y = new Uint8Array(new Int32Array(d.shape).buffer),
          w = new Uint8Array(new Int32Array(p.shape).buffer),
          I = o.dataIdMap.get(h.dataId).id,
          v = function () {
        return i(l, y, d.shape.length, m, w, p.shape.length, f[d.dtype], I);
      };

      if (r) return v(), h;

      var g = _tfjsCore.backend_util.getBroadcastDims(d.shape, b),
          k = _tfjsCore.backend_util.getBroadcastDims(p.shape, b),
          M = g.every(function (e, n) {
        return e === n;
      }),
          F = k.every(function (e, n) {
        return e === n;
      });

      if (M && F) return v(), h;
      throw new Error("Broadcasting along outer dims is not yet supported for " + a + ".");
    }
  });
}
...
b("Add", !0), (0, _tfjsCore.registerKernel)({
  kernelName: "AddN",
  backendName: "wasm",
  setupFunc: function (e) {
    h = e.wasm.cwrap("AddN", null, ["array", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var t = e.inputs,
        a = e.backend,
    ...
    return h(i, u.length, f[r.dtype], o), r;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "ArgMax",
  backendName: "wasm",
  kernelFunc: function (e) {
    var t = e.inputs.x,
        ...
        r = e.attrs.axis,
        u = t.shape.slice(0, -1),
        i = a.makeOutput(u, "int32"),
        o = a.dataIdMap.get(t.dataId).id,
        s = a.dataIdMap.get(i.dataId).id,
        d = _tfjsCore.util.sizeFromShape(i.shape),
        p = t.shape[r];

    return y(o, f[t.dtype], d, p, s), i;
  },
  setupFunc: function (e) {
    y = e.wasm.cwrap("ArgMax", null, ["number", "number", "number", "number", "number"]);
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "AvgPool",
  backendName: "wasm",
  setupFunc: function (e) {
    w = e.wasm.cwrap("AvgPool", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
        ...
        f = r.strideWidth,
        b = r.inChannels;
    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    if (1 !== r.dilationWidth || 1 !== r.dilationHeight) throw new Error("was backend only supports average pooling with dilation = [1, 1], got [" + r.dilationHeight + ", " + r.dilationWidth + "].");
    var h = a.makeOutput(r.outShape, "float32"),
        y = a.dataIdMap.get(h.dataId).id;
    return w(i, u.shape[0], u.shape[1], u.shape[2], o, s, d, p, l, m, c, f, b, y), h;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "BatchMatMul",
  backendName: "wasm",
  setupFunc: function (e) {
    I = e.wasm.cwrap("BatchMatMul", null, ["number", "array", "number", "number", "array", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.backend,
    ...
    var i = a.transposeA,
        ...
        l = o ? u.shape[1] : u.shape[2],
        m = r.shape[0],
        c = t.makeOutput([m, p, l], r.dtype),
    ...
    return I(s, b, r.shape.length, d, h, u.shape.length, i, o, f), c;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Cast",
  backendName: "wasm",
  ...
  backendName: "wasm",
  setupFunc: function (e) {
    v = e.wasm.cwrap("ClipByValue", null, ["number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.backend,
        ...
        s = t.makeOutput(r.shape, "float32"),
  ...
  backendName: "wasm",
  kernelFunc: function (e) {
    for (var a = e.inputs, r = e.backend, u = e.attrs.axis, i = _tfjsCore.backend_util.computeOutShape(a.map(function (e) {
      return e.shape;
    }), u), o = r.makeOutput(i, a[0].dtype), s = _tfjsCore.util.sizeFromShape(a[0].shape.slice(0, u)), d = 0, p = a.map(function (e) {
      var t = _tfjsCore.util.sizeFromShape(e.shape.slice(u));

      return d += t, t;
    }), l = a.map(function (e) {
      return r.typedArrayFromHeap(e);
    }), m = r.typedArrayFromHeap(o), c = 0; c < s; c++) for (var f = c * d, b = 0; b < l.length; b++) {
      var h = p[b],
          y = c * h,
          w = l[b].subarray(y, y + h);
      m.set(w, f), f += h;
    }
  ...
  backendName: "wasm",
  setupFunc: function (e) {
    g = e.wasm.cwrap("Conv2D", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
    ...
    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend Conv2D does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    var M = a.makeOutput(r.outShape, "float32"),
        F = a.dataIdMap.get(M.dataId).id;
    return g(o, u.shape[0], u.shape[1], u.shape[2], s, d, p, l, m, c, f, k, b, h, y, w, I, v, F), M;
  }
}), function (e) {
  e[e.bilinear = 0] = "bilinear", e[e.nearest = 1] = "nearest";
}(k || (k = {})), (0, _tfjsCore.registerKernel)({
  kernelName: "CropAndResize",
  backendName: "wasm",
  setupFunc: function (e) {
    M = e.wasm.cwrap("CropAndResize", null, ["number", "number", "number", "number", "array", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n,
        t = e.backend,
    ...
    }), h = t.dataIdMap.get(n.dataId));
    var y = h.id,
        w = t.dataIdMap.get(d.dataId).id,
        I = t.dataIdMap.get(p.dataId).id,
        v = t.makeOutput(b, "float32"),
        g = t.dataIdMap.get(v.dataId).id,
        F = new Uint8Array(new Int32Array(s.shape).buffer);
    return M(y, w, I, l, F, c, f, k[u], i, g), null != n && t.disposeData(n.dataId), v;
  }
}), c("Cos"), (0, _tfjsCore.registerKernel)({
  kernelName: "DepthwiseConv2dNative",
  backendName: "wasm",
  setupFunc: function (e) {
    F = e.wasm.cwrap("DepthwiseConv2dNative", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
        ...
        I = r.inChannels,
        v = r.outChannels,
        g = "SAME" === r.padInfo.type ? 1 : 0;
    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend DepthwiseConv2dNative does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    var k = a.makeOutput(r.outShape, "float32"),
        M = a.dataIdMap.get(k.dataId).id;
    return F(o, u.shape[0], u.shape[1], u.shape[2], s, d, p, l, m, c, f, g, b, h, y, w, I, v, M), k;
  }
});
b("Div", !1), c("Exp");
...
b("FloorDiv", !1), (0, _tfjsCore.registerKernel)({
  kernelName: "BatchNormalization",
  backendName: "wasm",
  setupFunc: function (e) {
    S = e.wasm.cwrap("FusedBatchNorm", null, ["number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var t = e.backend,
        a = e.inputs,
        ...
        c = null != s ? t.dataIdMap.get(s.dataId).id : 0,
        f = null != d ? t.dataIdMap.get(d.dataId).id : 0,
        b = t.makeOutput(u.shape, u.dtype);
    if (0 === _tfjsCore.util.sizeFromShape(u.shape)) return b;
    var h = t.dataIdMap.get(b.dataId).id;
    return S(p, l, m, c, f, r, h), b;
  }
}), function (e) {
  e[e.linear = 0] = "linear", e[e.relu = 1] = "relu", e[e.relu6 = 2] = "relu6", e[e.prelu = 3] = "prelu";
}(N || (N = {})), (0, _tfjsCore.registerKernel)({
  kernelName: "FusedConv2D",
  backendName: "wasm",
  setupFunc: function (e) {
    x = e.wasm.cwrap("FusedConv2D", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
        ...
        u = t.activation,
        i = N[u];
    if (null == i) throw new Error(u + " activation not yet supported for FusedConv2D in the wasm backend.");
    var o = n.x,
        s = n.filter,
        d = n.bias,
        p = n.preluActivationWeights,
    ...
    if (null != d) {
      var b = a.dataIdMap.get(d.dataId);
      if (1 !== b.shape.length) throw new Error("FusedConv2D only supports rank-1 bias but got rank " + b.shape.length + ".");
      if (b.shape[0] !== c) throw new Error("FusedConv2D bias shape (" + b.shape + ") does not match the number of output channels (" + c + ")");
      f = b.id;
    }

    var h = r.filterHeight,
        y = r.filterWidth,
        w = r.padInfo.top,
        I = r.padInfo.right,
        v = r.padInfo.bottom,
        ...
        A = r.strideWidth,
        S = r.inChannels,
        _ = "SAME" === r.padInfo.type ? 1 : 0,
        E = r.batchSize,
        C = r.inHeight,
        O = r.inWidth;

    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend FusedConv2D does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    var D = a.makeOutput(r.outShape, "float32"),
        z = a.dataIdMap.get(D.dataId).id,
        R = null == p ? 0 : a.dataIdMap.get(p.dataId).id;
    return x(l, E, C, O, m, h, y, f, w, I, v, g, _, k, M, F, A, S, c, i, R, z), D;
  }
}), function (e) {
  e[e.linear = 0] = "linear", e[e.relu = 1] = "relu", e[e.relu6 = 2] = "relu6", e[e.prelu = 3] = "prelu";
}(E || (E = {})), (0, _tfjsCore.registerKernel)({
  kernelName: "FusedDepthwiseConv2D",
  backendName: "wasm",
  setupFunc: function (e) {
    _ = e.wasm.cwrap("FusedDepthwiseConv2D", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
        ...
        u = t.activation,
        i = E[u];
    if (null == i) throw new Error(u + " activation not yet supported for FusedDepthwiseConv2D in the wasm backend.");
    var o = n.x,
        s = n.filter,
        d = n.bias,
        p = n.preluActivationWeights,
    ...
    if (null != d) {
      var b = a.dataIdMap.get(d.dataId);
      if (1 !== b.shape.length) throw new Error("FusedDepthwiseConv2D only supports rank-1 bias but got rank " + b.shape.length + ".");
      if (b.shape[0] !== c) throw new Error("FusedDepthwiseConv2D bias shape (" + b.shape + ") does not match the number of output channels (" + c + ")");
      f = b.id;
    }
    ...
    var h = r.filterHeight,
        ...
        A = r.strideWidth,
        S = r.inChannels,
        x = "SAME" === r.padInfo.type ? 1 : 0,
        N = r.batchSize,
        C = r.inHeight,
        O = r.inWidth;
    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend FusedDepthwiseConv2D does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    var D = a.makeOutput(r.outShape, "float32"),
        z = a.dataIdMap.get(D.dataId).id,
        R = null == p ? 0 : a.dataIdMap.get(p.dataId).id;
    return _(l, N, C, O, m, h, y, f, w, I, v, g, x, k, M, F, A, S, c, i, R, z), D;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Gather",
  backendName: "wasm",
  setupFunc: function (e) {
    C = e.wasm.cwrap("Gather", null, ["number", "number", "array", "number", "number", "number", "array", "number"]);
  },
  kernelFunc: function (e) {
    var t = e.backend,
        a = e.inputs,
        ...
        o = r.axis,
        s = u.shape.slice();
    s[o] = _tfjsCore.util.sizeFromShape(i.shape);
    var d = u.shape.length - 1,
        p = t.makeOutput(s, u.dtype);
    if (0 === _tfjsCore.util.sizeFromShape(u.shape)) return p;
    var l = t.dataIdMap.get(u.dataId).id,
        m = t.dataIdMap.get(i.dataId).id,
        c = t.dataIdMap.get(p.dataId).id,
        b = new Uint8Array(new Int32Array(_tfjsCore.util.computeStrides(u.shape)).buffer),
        h = new Uint8Array(new Int32Array(_tfjsCore.util.computeStrides(s)).buffer);
    return C(l, f[u.dtype], b, d, m, o, h, c), p;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "GatherNd",
  backendName: "wasm",
  setupFunc: function (e) {
    O = e.wasm.cwrap("GatherNd", null, ["number", "number", "number", "number", "number", "number", "array", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.backend,
        t = e.inputs,
        r = t.x,
        u = t.indices,
        i = _tfjsCore.gather_util.prepareAndValidate(r, u),
        o = i[0],
        s = i[1],
        d = i[2],
        p = i[3],
        l = n.makeOutput(o, r.dtype);

    if (0 === s) return l;
    var m = u.shape,
        c = m[m.length - 1],
        b = n.dataIdMap.get(r.dataId).id,
        h = n.dataIdMap.get(u.dataId).id,
        y = new Uint8Array(new Int32Array(p).buffer),
        w = n.dataIdMap.get(l.dataId).id;
    return O(b, f[r.dtype], h, s, c, d, y, w), l;
  }
});
b("Greater", !1, "bool");
b("GreaterEqual", !1, "bool");
b("LogicalAnd", !1, "bool");
b("Less", !1, "bool");
var D;
b("LessEqual", !1, "bool"), c("Log"), (0, _tfjsCore.registerKernel)({
  kernelName: "Max",
  backendName: "wasm",
  setupFunc: function (e) {
    D = e.wasm.cwrap("Max", null, ["number, number, number"]);
  },
  kernelFunc: function (e) {
    var a = e.backend,
        r = e.inputs,
    ...
    _tfjsCore.backend_util.assertAxesAreInnerMostDims("max", u, i.shape.length);

    var s = _tfjsCore.backend_util.computeOutAndReduceShapes(i.shape, u),
        d = s[0],
        p = s[1],
        l = _tfjsCore.util.sizeFromShape(p),
        m = a.makeOutput(d, i.dtype);

    if (0 === _tfjsCore.util.sizeFromShape(i.shape)) return m;
    var c = a.dataIdMap.get(m.dataId).id;
    return D(o, l, c), m;
  }
});
var z, R;
b("Maximum", !1), (0, _tfjsCore.registerKernel)({
  kernelName: "MaxPool",
  backendName: "wasm",
  setupFunc: function (e) {
    z = e.wasm.cwrap("MaxPool", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.attrs,
        ...
        w = r.outChannels;
    if ("channelsLast" !== r.dataFormat) throw new Error("wasm backend does not support dataFormat:'" + r.dataFormat + "'. Please use 'channelsLast'.");
    var I = a.makeOutput(r.outShape, "float32"),
        v = a.dataIdMap.get(I.dataId).id;
    return z(i, u.shape[0], u.shape[1], u.shape[2], o, s, d, p, l, m, c, f, b, h, y, w, v), I;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Min",
  backendName: "wasm",
  setupFunc: function (e) {
    R = e.wasm.cwrap("Min", null, ["number, number, number"]);
  },
  kernelFunc: function (e) {
    var a = e.backend,
        r = e.inputs,
    ...
    _tfjsCore.backend_util.assertAxesAreInnerMostDims("min", u, i.shape.length);
...
function V(e) {
  var t = e.inputs.x,
      ...
      o = a.size,
      s = e.backend,
      d = _tfjsCore.slice_util.isSliceContinous(t.shape, r, o),
      p = s.typedArrayFromHeap(t),
      l = s.makeOutput(o, t.dtype),
      m = s.typedArrayFromHeap(l),
      c = _tfjsCore.util.computeStrides(t.shape);

  if (d) {
    var f = _tfjsCore.slice_util.computeFlatOffset(r, c);

    return m.set(p.subarray(f, f + _tfjsCore.util.sizeFromShape(o))), l;
  }

  var b = t.shape.length;
  return 2 === b ? function (e, n, t, a, r) {
    for (var u = 0, i = a[0], o = a[1], s = i + r[0], d = i; d < s; d++) {
      var p = d * n + o;
      t.set(e.subarray(p, p + r[1]), u), u += r[1];
    }
  }(p, c[0], m, r, o) : 3 === b ? function (e, n, t, a, r, u) {
    for (var i = 0, o = r[0], s = r[1], d = r[2], p = o + u[0], l = s + u[1], m = o; m < p; m++) for (var c = s; c < l; c++) {
      var f = m * n + c * t + d;
      a.set(e.subarray(f, f + u[2]), i), i += u[2];
    }
  }(p, c[0], c[1], m, r, o) : 4 === b ? function (e, n, t, a, r, u, i) {
    for (var o = 0, s = u[0], d = u[1], p = u[2], l = s + i[0], m = d + i[1], c = p + i[2], f = u[3], b = s; b < l; b++) for (var h = d; h < m; h++) for (var y = p; y < c; y++) {
      var w = b * n + h * t + y * a + f;
      r.set(e.subarray(w, w + i[3]), o), o += i[3];
    }
  }(p, c[0], c[1], c[2], m, r, o) : function (e, n, t, a, r) {
    for (var u = (0, _tfjsCore.buffer)(r, n.dtype, t), o = (0, _tfjsCore.buffer)(n.shape, n.dtype, e), s = 0; s < u.size; ++s) {
      var d = u.indexToLoc(s).map(function (e, n) {
        return e + a[n];
      });
      t[s] = o.get.apply(o, d);
    }
...
b("Mul", !0), (0, _tfjsCore.registerKernel)({
  kernelName: "NonMaxSuppressionV3",
  backendName: "wasm",
  setupFunc: function (e) {
    P = e.wasm.cwrap("NonMaxSuppressionV3", "number", ["number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.backend,
        t = e.inputs,
  ...
  backendName: "wasm",
  setupFunc: function (e) {
    H = e.wasm.cwrap("NonMaxSuppressionV5", "number", ["number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.backend,
        t = e.inputs,
  ...
  kernelFunc: function (e) {
    var n = e.inputs.x,
      ...
      return e[0] + n.shape[t] + e[1];
        ...
        s = t.makeOutput(i, n.dtype),
        d = t.dataIdMap.get(s.dataId).id,
        p = new Uint8Array(new Int32Array(n.shape).buffer),
        l = [].concat.apply([], r),
        m = new Uint8Array(new Int32Array(l).buffer);
    return W(o, p, n.shape.length, f[n.dtype], m, u, d), s;
  },
  setupFunc: function (e) {
    W = e.wasm.cwrap("PadV2", null, ["number", "array", "number", "number", "array", "number", "number"]);
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Prelu",
  backendName: "wasm",
  setupFunc: function (e) {
    U = e.wasm.cwrap("Prelu", null, ["number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var n = e.inputs,
        t = e.backend,
        ...
        o = t.makeOutput(a.shape, "float32"),
        s = t.dataIdMap.get(o.dataId).id;
    return U(u, i, s), o;
  }
}), c("Relu"), c("Relu6"), (0, _tfjsCore.registerKernel)({
  kernelName: "Reshape",
  backendName: "wasm",
  kernelFunc: function (e) {
    var n = e.inputs.x,
  ...
  backendName: "wasm",
  setupFunc: function (e) {
    T = e.wasm.cwrap("ResizeBilinear", null, ["number", "number", "number", "number", "number", "number", "number", "number", "number"]);
  },
  kernelFunc: function (e) {
    var t,
        a = e.backend,
    ...
    var y = h.id,
        w = a.makeOutput(b, "float32");
    if (0 === _tfjsCore.util.sizeFromShape(i.shape)) return w;
    var I = a.dataIdMap.get(w.dataId).id;
    return T(y, l, m, c, f, s, d, o ? 1 : 0, I), null != t && a.disposeData(t.dataId), w;
  }
}), c("Rsqrt"), (0, _tfjsCore.registerKernel)({
  kernelName: "ScatterNd",
  backendName: "wasm",
  setupFunc: function (e) {
    B = e.wasm.cwrap("ScatterNd", null, ["number", "number", "number", "number", "number", "number", "array", "number", "number"]);
  },
  kernelFunc: function (e) {
    var t = e.backend,
        a = e.inputs,
        ...
        o = a.updates,
        s = u.shape,
        d = t.makeOutput(s, o.dtype);
    if (0 === _tfjsCore.util.sizeFromShape(s)) return d;

    var p = _tfjsCore.scatter_util.calculateShapes(o, i, s),
        l = p.sliceRank,
        m = p.numUpdates,
        c = p.sliceSize,
        b = p.strides,
        ...
        w = t.dataIdMap.get(o.dataId).id,
        I = new Uint8Array(new Int32Array(b).buffer),
        v = t.dataIdMap.get(d.dataId).id;

    return B(y, w, f[o.dtype], l, m, c, I, h, v), d;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Sigmoid",
  backendName: "wasm",
  setupFunc: function (e) {
    L = e.wasm.cwrap("Sigmoid", null, ["number", "number"]);
  },
  kernelFunc: function (e) {
    var t = e.backend,
        a = e.inputs.x,
    ...
    return 0 === _tfjsCore.util.sizeFromShape(u.shape) ? u : (L(r, i), u);
  }
}), c("Sin"), (0, _tfjsCore.registerKernel)({
  kernelName: "Slice",
  backendName: "wasm",
  kernelFunc: V
}), c("Square");
var G, q, X;
b("Sub", !0), (0, _tfjsCore.registerKernel)({
  kernelName: "Sum",
  backendName: "wasm",
  setupFunc: function (e) {
    G = e.wasm.cwrap("Sum", null, ["number, number, number"]);
  },
  kernelFunc: function (e) {
    var a = e.backend,
        r = e.inputs,
    ...
    _tfjsCore.backend_util.assertAxesAreInnerMostDims("sum", u, i.shape.length);
...
}), c("Tanh"), (0, _tfjsCore.registerKernel)({
  kernelName: "Tile",
  backendName: "wasm",
  setupFunc: function (e) {
    q = e.wasm.cwrap("Tile", null, ["number", "array", "number", "array", "number", "number"]);
  },
  kernelFunc: function (e) {
    for (var n = e.inputs, t = e.backend, a = e.attrs, r = n.x, u = t.dataIdMap.get(r.dataId).id, i = a.reps, o = new Array(r.shape.length), s = 0; s < o.length; s++) o[s] = r.shape[s] * i[s];

    var d = new Uint8Array(new Int32Array(r.shape).buffer),
        p = new Uint8Array(new Int32Array(o).buffer),
        l = t.makeOutput(o, r.dtype),
        m = t.dataIdMap.get(l.dataId).id;
    return q(u, d, r.shape.length, p, o.length, f[l.dtype], m), l;
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Transpose",
  backendName: "wasm",
  kernelFunc: function (e) {
    for (var n = e.inputs, t = e.backend, a = e.attrs, r = function (e, n) {
      ...
      return [t, a];
    }(n.x.shape, a.perm), u = r[0], i = r[1], o = {
      dataId: n.x.dataId,
      shape: u,
      dtype: n.x.dtype
    }, s = !0, d = 0; d < i.length; d++) i[d] !== d && (s = !1);
    ...
    var l = t.makeOutput(p, o.dtype),
        m = t.dataIdMap.get(o.dataId).id,
        c = t.dataIdMap.get(l.dataId).id,
        b = new Uint8Array(new Int32Array(i).buffer),
        h = new Uint8Array(new Int32Array(o.shape).buffer);
    return X(m, h, o.shape.length, f[o.dtype], c, b, i.length), l;
  },
  setupFunc: function (e) {
    X = e.wasm.cwrap("Transpose", null, ["number", "array", "number", "number", "number", "array", "number"]);
  }
}), (0, _tfjsCore.registerKernel)({
  kernelName: "Unpack",
  backendName: "wasm",
  kernelFunc: function (e) {
    for (var n = e.inputs.x, t = e.backend, a = e.attrs.axis, r = n.shape[a], u = n.shape.length, i = new Array(u - 1), o = 0, s = 0; s < u; s++) s !== a && (i[o++] = n.shape[s]);

    var d = new Array(r),
        p = new Array(u).fill(0),
        l = n.shape.slice();

    for (l[a] = 1, s = 0; s < d.length; s++) p[a] = s, d[s] = V({
      inputs: {
        x: n
      },
      attrs: {
  ...
  function o(u) {
    return function (o) {
      return function (u) {
        ...
        for (; i;) try {
          if (t = 1, a && (r = 2 & u[0] ? a.return : u[0] ? a.throw || ((r = a.return) && r.call(a), 0) : a.next) && !(r = r.call(a, u[1])).done) return r;
...
var K = function (e, n) {
  ...
  var t,
      a = (t = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, function (e) {
    var n,
        a = void 0 !== (e = e || {}) ? e : {},
        r = {};
    ...
    var u = !1,
        ...
        o = !1,
        s = !1;
    u = "object" == typeof window, i = "function" == typeof importScripts, o = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node && !u && !i, s = !u && !o && !i;
    var d,
        p,
        c,
        f,
    ...
    function h(e) {
      return a.locateFile ? a.locateFile(e, b) : b + e;
    }

    o ? (b = __dirname + "/", d = function (e, n) {
      var t;
      return c || (c = _fs.default), f || (f = _path.default), e = f.normalize(e), t = c.readFileSync(e), n ? t : t.toString();
    }, p = function (e) {
      var n = d(e, !0);
    ...
    }), process.on("unhandledRejection", oe), a.inspect = function () {
    ...
    }, "undefined" != typeof scriptArgs && scriptArgs, "undefined" != typeof print && ("undefined" == typeof console && (console = {}), console.log = print, console.warn = console.error = "undefined" != typeof printErr ? printErr : print)) : (u || i) && (i ? b = self.location.href : document.currentScript && (b = document.currentScript.src), t && (b = t), b = 0 !== b.indexOf("blob:") ? b.substr(0, b.lastIndexOf("/") + 1) : "", d = function (e) {
    ...
    var y,
        ...
        v = a.printErr || console.warn.bind(console);

    for (n in r) r.hasOwnProperty(n) && (a[n] = r[n]);

    r = null, a.arguments && a.arguments, a.thisProgram && a.thisProgram, a.quit && a.quit, a.wasmBinary && (y = a.wasmBinary), a.noExitRuntime && a.noExitRuntime, "object" != typeof WebAssembly && v("no native wasm support detected");
    ...
    function A(e, n, t, a, r) {
      ...
      if (a) for (var d = 0; d < a.length; d++) {
        var p = u[t[d]];
        p ? (0 === s && (s = Ne()), o[d] = p(a[d])) : o[d] = a[d];
      }
      var l = i.apply(null, o);
      return l = function (e) {
        return "string" === n ? _(e) : "boolean" === n ? Boolean(e) : e;
      }(l), 0 !== s && Ee(s), l;
    }
    ...
    function S(e, n, t, a) {
      ...
      return "string" !== n && r && !a ? F(e) : function () {
    ...
    function N(e, n, t) {
      ...
      if (r - n > 16 && e.subarray && x) return x.decode(e.subarray(n, r));
      ...
      for (var u = ""; n < r;) {
        ...
        if (128 & i) {
          ...
          if (192 != (224 & i)) {
            var s = 63 & e[n++];
            if ((i = 224 == (240 & i) ? (15 & i) << 12 | o << 6 | s : (7 & i) << 18 | o << 12 | s << 6 | 63 & e[n++]) < 65536) u += String.fromCharCode(i);else {
              var d = i - 65536;
    ...
    function E(e, n, t, a) {
      ...
      for (var r = t, u = t + a - 1, i = 0; i < e.length; ++i) {
        ...
        if (o >= 55296 && o <= 57343 && (o = 65536 + ((1023 & o) << 10) | 1023 & e.charCodeAt(++i)), o <= 127) {
          if (t >= u) break;
          n[t++] = o;
        } else if (o <= 2047) {
          if (t + 1 >= u) break;
          n[t++] = 192 | o >> 6, n[t++] = 128 | 63 & o;
        } else if (o <= 65535) {
          if (t + 2 >= u) break;
          n[t++] = 224 | o >> 12, n[t++] = 128 | o >> 6 & 63, n[t++] = 128 | 63 & o;
        } else {
          if (t + 3 >= u) break;
          n[t++] = 240 | o >> 18, n[t++] = 128 | o >> 12 & 63, n[t++] = 128 | o >> 6 & 63, n[t++] = 128 | 63 & o;
        }
      }
    ...
    function U(e) {
      D = e, a.HEAP8 = z = new Int8Array(e), a.HEAP16 = new Int16Array(e), a.HEAP32 = P = new Int32Array(e), a.HEAPU8 = R = new Uint8Array(e), a.HEAPU16 = new Uint16Array(e), a.HEAPU32 = new Uint32Array(e), a.HEAPF32 = new Float32Array(e), a.HEAPF64 = new Float64Array(e);
    }

    var T = 5252736,
        B = 9696,
        L = a.TOTAL_MEMORY || 16777216;
    ...
    (w = a.wasmMemory ? a.wasmMemory : new WebAssembly.Memory({
      initial: L / H
    })) && (D = w.buffer), L = D.byteLength, U(D), P[B >> 2] = T;
    var V = [],
        G = [],
        q = [],
        X = [];
    ...
    function Y() {
      if (a.preRun) for ("function" == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;) Q(a.preRun.shift());
      j(V);
    }
    ...
    function ue(e) {
      te++, a.monitorRunDependencies && a.monitorRunDependencies(te);
    }

    function ie(e) {
      if (te--, a.monitorRunDependencies && a.monitorRunDependencies(te), 0 == te && (null !== ae && (clearInterval(ae), ae = null), re)) {
        var n = re;
        re = null, n();
      }
    }
    ...
    function oe(e) {
      throw a.onAbort && a.onAbort(e), I(e += ""), v(e), k = !0, e = "abort(" + e + "). Build with -s ASSERTIONS=1 for more info.", new WebAssembly.RuntimeError(e);
    }
    ...
    function me() {
      return y || !u && !i || "function" != typeof fetch ? new Promise(function (e, n) {
        e(le());
      }) : fetch(pe, {
    ...
    function ce() {
      ...
      function r(n) {
        return me().then(function (n) {
          return WebAssembly.instantiate(n, e);
        }).then(n, function (e) {
          v("failed to asynchronously prepare wasm: " + e), oe(e);
        });
      }

      if (ue(), a.instantiateWasm) try {
        return a.instantiateWasm(e, n);
      } catch (e) {
        return v("Module.instantiateWasm callback failed with error: " + e), !1;
      }
      return function () {
        if (y || "function" != typeof WebAssembly.instantiateStreaming || de(pe) || "function" != typeof fetch) return r(t);
        fetch(pe, {
          credentials: "same-origin"
        }).then(function (n) {
    ...
    function we(e) {
      ...
      for (var t = Math.max(n, 16777216); t < e;) t = t <= 536870912 ? W(2 * t, 65536) : Math.min(W((3 * t + 2147483648) / 4, 65536), 2147418112);

      return !!ye(t);
    }

    de(pe) || (pe = h(pe)), G.push({
      func: function () {
        xe();
      }
    });
    var Ie = {
      ...
      printChar: function (e, n) {
        var t = Ie.buffers[e];
        0 === n || 10 === n ? ((1 === e ? I : v)(N(t, 0)), t.length = 0) : t.push(n);
      },
      varargs: 0,
      get: function (e) {
        return Ie.varargs += 4, P[Ie.varargs - 4 >> 2];
      },
      getStr: function () {
        return _(Ie.get());
      },
    ...
    function ve(e) {
      try {
        ...
        return "undefined" != typeof FS && e instanceof FS.ErrnoError || oe(e), e.errno;
      }
    }
    ...
    function ke(e, n, t, a) {
      try {
        for (var r = 0, u = 0; u < t; u++) {
          for (var i = P[n + 8 * u >> 2], o = P[n + (8 * u + 4) >> 2], s = 0; s < o; s++) Ie.printChar(e, R[i + s]);
    ...
    var Se,
        xe = a.___wasm_call_ctors = function () {
      ...
      return a.asm.ia.apply(null, arguments);
        ...
        _e = a.stackAlloc = function () {
      return a.asm.ja.apply(null, arguments);
    },
        Ee = a.stackRestore = function () {
    ...
    function Oe(e) {
      function n() {
        Se || (Se = !0, k || (Z(), J(), a.onRuntimeInitialized && a.onRuntimeInitialized(), K()));
      }

      te > 0 || (Y(), te > 0 || (a.setStatus ? (a.setStatus("Running..."), setTimeout(function () {
        setTimeout(function () {
          a.setStatus("");
        }, 1), n();
      }, 1)) : n()));
    ...
    }, a.asm = Ae, a.cwrap = S, a.then = function (e) {
      if (Se) e(a);else {
  ...
  function t(n) {
    ...
    return t.wasm = n, t.dataIdNextNumber = 1, t.wasm.tfjs.init(), t.dataIdMap = new _tfjsCore.DataStorage(t, (0, _tfjsCore.engine)()), t;
  }
  ...
  return function (e, n) {
  ...
  }(t, e), t.prototype.write = function (e, n, t) {
    var a = {};
    ...
    return Z(this, void 0, void 0, function () {
      ...
      return J(this, function (a) {
        return t = _tfjsCore.util.now(), e(), [2, {
    ...
    if ("string" !== r) {
      var i = _tfjsCore.util.sizeFromShape(a),
          o = i * _tfjsCore.util.bytesPerElement(r),
          s = this.wasm._malloc(o);
      ...
      this.dataIdMap.set(e, {
        ...
        shape: a,
        dtype: r
      }), this.wasm.tfjs.registerTensor(u, i, s), null != t && this.wasm.HEAPU8.set(new Uint8Array(t.buffer, 0, o), s);
    } else {
      var d = t;
      this.dataIdMap.set(e, {
        id: u,
    ...
    var t = this.dataIdMap.get(e),
        ...
        u = t.shape,
        i = t.stringBytes;
    return "string" === r ? i : function (e, n) {
      switch (n) {
        case "float32":
    ...
    }(this.wasm.HEAPU8.slice(a, a + _tfjsCore.util.sizeFromShape(u) * _tfjsCore.util.bytesPerElement(r)).buffer, r);
    ...
    var r;
    if (null == a) r = this.write(null, e, t);else {
      r = {};
      var u = this.dataIdNextNumber++;
      ...
      var i = _tfjsCore.util.sizeFromShape(e);
    ...
    var t = e.shape,
        ...
        o = _tfjsCore.util.sizeFromShape(t);

    switch (a) {
      case "float32":
        return new Float32Array(u, i, o);

      case "int32":
        return new Int32Array(u, i, o);

      case "bool":
        return new Uint8Array(u, i, o);

      default:
        throw new Error("Uknown dtype " + a);
    }
  }, t;
}(_tfjsCore.KernelBackend);

exports.BackendWasm = Q;
...
function $() {
  return Z(this, void 0, void 0, function () {
    return J(this, function (e) {
      return [2, new Promise(function (e, n) {
        var t = {};
        null != ee && (t.locateFile = function (e, n) {
          return e.endsWith(".wasm") ? ee : n + e;
        });
        var a = K(t);
        a.tfjs = {
          init: a.cwrap("init", null, []),
          registerTensor: a.cwrap("register_tensor", null, ["number", "number", "number"]),
...
(0, _tfjsCore.registerBackend)("wasm", function () {
  return Z(void 0, void 0, void 0, function () {
    ...
    return J(this, function (n) {
      switch (n.label) {
        ...
        case 1:
          return e = n.sent().wasm, [2, new Q(e)];
      }
    });
  });
}, 2);
...
function te(e) {
  if (ne) throw new Error("The WASM backend was already initialized. Make sure you call `setWasmPath()` before you call `tf.setBackend()` or `tf.ready()`");
  ee = e;
}
},{"@tensorflow/tfjs-core":"PqBP","fs":"sC8V","path":"sC8V","process":"g5I+"}],"Focm":[function(require,module,exports) {
"use strict";

var blazeface = _interopRequireWildcard(require("@tensorflow-models/blazeface"));
...
gui.add(state, 'backend', ['wasm']).onChange(async backend => {
...
setupPage();
},{"@tensorflow-models/blazeface":"XIac","@tensorflow/tfjs-core":"PqBP","@tensorflow/tfjs-backend-wasm":"M1oU"}]},{},["Focm"], null)
//# sourceMappingURL=demo.b4b3415e.map
